            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">投票列表</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="dianyingNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="投票视频" aria-controls="tableId">
                                    </div>
                                </div>
...
<script>
    ...
    function search() {
        ...
        if( yonghuPhoneSearchInput != null){
            ...
            //投票视频
        var dianyingIdStartSearchInput = $('#dianyingIdStartSearch');
        if(dianyingIdStartSearchInput != null){
            var dianyingIdStartSearchValue = dianyingIdStartSearchInput.val();
            if( dianyingIdStartSearchValue  != 0){
                searchForm.dianyingIdStart = dianyingIdStartSearchValue;
            }
        }
        var dianyingIdEndSearchInput = $('#dianyingIdEndSearch');
        if(dianyingIdEndSearchInput != null){
            var dianyingIdEndSearchValue = dianyingIdEndSearchInput.val();
            if( dianyingIdEndSearchValue  != 0){
                searchForm.dianyingIdEnd = dianyingIdEndSearchValue;
            }
        }
                    getDataList();
    }
    ...
    function getDataList() {
        http("voting/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            dianyingIdStart: searchForm.dianyingIdStart,
            dianyingIdEnd: searchForm.dianyingIdEnd,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        // 整数
        function dianyingIdChickValue(e){
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("voting/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addvoting", "addvoting");
        window.location.href = "add-or-update.jsp"
    }
