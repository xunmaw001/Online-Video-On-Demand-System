    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">视频收藏管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">视频收藏列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">视频收藏列表</h3>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        row.appendChild(dianyingZhuyanCell);
            ...
            //视频海报
        var yangbanPhotoCell = document.createElement('td');
        var yangbanPhotoImg = document.createElement('img');
        var yangbanPhotoImgValue = item.yangbanPhoto;
        if(yangbanPhotoImgValue !=null && yangbanPhotoImgValue !='' && yangbanPhotoImgValue !='null'){
                yangbanPhotoImg.setAttribute('src', yangbanPhotoImgValue);
                yangbanPhotoImg.setAttribute('height', 100);
                yangbanPhotoImg.setAttribute('width', 100);
                yangbanPhotoCell.appendChild(yangbanPhotoImg);
        }else{
                yangbanPhotoCell.innerHTML = "暂无图片";
        }
        row.appendChild(yangbanPhotoCell);
