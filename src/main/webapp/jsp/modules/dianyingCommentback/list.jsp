    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">视频评论管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">视频评论列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">视频评论列表</h3>
...
<script>
    ...
    function getDataList() {
        http("dianyingCommentback/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
    ...
    function setDataRow(item, number) {
        ...
        //评论内容
        var dianyingCommentbackContentCell = document.createElement('td');
        dianyingCommentbackContentCell.innerHTML = item.dianyingCommentbackContent;
        row.appendChild(dianyingCommentbackContentCell);
        ...
        detailBtn.setAttribute("class", "btn btn-info btn-sm 查看回复");
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("dianyingCommentback/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("adddianyingCommentback", "adddianyingCommentback");
        window.location.href = "add-or-update.jsp"
    }
