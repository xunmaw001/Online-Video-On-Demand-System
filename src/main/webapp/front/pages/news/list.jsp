                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">动态名称</label>
                          <div class="layui-input-inline">
                              <input type="text" name="newsName" id="newsName" placeholder="动态名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                            ...
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../news/detail.jsp?id='+item.id">
                                        ...
                                        <p class="reamk">{{item.newsContent|newContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
