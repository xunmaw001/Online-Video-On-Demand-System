            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">投票展示</span>
                ...
                <fieldset class="search-container" style="text-align: center;">
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">投票视频</label>
                          <div class="layui-input-inline">
                              <input type="text" name="dianyingIdStart" id="dianyingIdStart"  lay-skin="integer"   placeholder="投票视频开始" autocomplete="off" class="layui-input">
                              -
                              <input type="text" name="dianyingIdend"   id="dianyingIdend"    lay-skin="integer|dianyingIdend"   placeholder="投票视频结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery'], function() {
        ...
        form.verify({
            ...
            ,dianyingIdend: function(value, item){ //value：表单的值、item：表单的DOM对象
                    var dianyingIdStart = $("#dianyingIdStart").val();
                 if(dianyingIdStart != null && dianyingIdStart != "" && dianyingIdStart != "null"){
                    var number = parseInt(value)- parseInt(dianyingIdStart);
                    if(number<0){
                        return '投票视频的结束值不能小于开始值';
                    }
                 }
            }
        ...
        function pageList() {
            ...
            if (jquery('#dianyingIdStart').val() != null && jquery('#dianyingIdStart').val() != "" && jquery('#dianyingIdStart').val() != "null" ) {
                param['dianyingIdStart'] = jquery('#dianyingIdStart').val();
            }
            if (jquery('#dianyingIdEnd').val() != null && jquery('#dianyingIdEnd').val() != "" && jquery('#dianyingIdEnd').val() != "null" ) {
                param['dianyingIdEnd'] = jquery('#dianyingIdEnd').val();
            }
                        // 获取列表数据
            http.request('voting/list', 'get', param, function(res) {
